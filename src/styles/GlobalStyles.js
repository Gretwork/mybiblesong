...
export const globalstyles = StyleSheet.create({
  ...
  HorScrollBoxConImg : {
    marginRight:20, marginBottom:0, width: windowWidth / 1.2, 
  ...
  AppUpdateAlertBoxCon : {
   ...
   width: windowWidth / 1.1, shadowColor:'red', shadowOpacity:1,
  },
  ...
  SongsListTabMainCon:{
    position:'absolute', backgroundColor:'white', width: windowWidth/1, height: windowHeight/2.4, zIndex:999999,
  ...
  Downloadimgbtn:{ backgroundColor:'#333', marginTop:-2, zIndex:-1, padding:15, marginBottom:20,
  borderBottomLeftRadius:4, borderBottomRightRadius:4, color:'#fff', textTransform:'uppercase',
  display:'flex', justifyContent:'space-around', alignItems:'center', textAlign:'center',
  flexDirection:'row',   textAlign:'center',  
  width:windowWidth/1.078, paddingTop:0, paddingBottom:0, 
},
DownloadimgbtnWhite:{ backgroundColor:'#fff', marginTop:-2, zIndex:-1, padding:15, marginBottom:20,
  borderBottomLeftRadius:4, borderBottomRightRadius:4, color:'#fff', textTransform:'uppercase',
  display:'flex', justifyContent:'space-around', alignItems:'center', textAlign:'center',
  flexDirection:'row',   textAlign:'center',  
  width:windowWidth/1.078, paddingTop:0, paddingBottom:0, 
...
borderBottomLeftRadius:4, borderBottomRightRadius:4, color:'#fff', textTransform:'uppercase',
display:'flex', justifyContent:'space-around', alignItems:'center', textAlign:'center',
flexDirection:'row',   textAlign:'center',  width:windowWidth/1.078, paddingTop:0, paddingBottom:0, 
},
