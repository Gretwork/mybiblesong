...
const Contactform = ({props, navigation}) => {
  ...
  const register = async (email, password, fname,lname,phone,city,state,country,message) => {
    try {
      await auth().createUserWithEmailAndPassword(email, password, fname,lname,phone,city,state,country,message)
      //alert('Please check your Email for verification link.')
      .then(() => {
        //Once the user creation has happened successfully, we can add the currentUser into firestore
        //with the appropriate details.
        firestore().collection('contactreq').doc(auth().currentUser.uid)
        .set({
            fname: fname,
            lname: lname,
            email: email,
 ...
 {/* 
      ...
      <FormButton
        buttonTitle="Submit"
        onPress={() => register(email, password, fname,lname,phone,city,state,country,message)}
