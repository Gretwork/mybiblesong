...
function Quizslider({props, navigation}) {
  ...
  //      const list = [];
  //      //console.log("Break");
  //      firestore().collection("biblequiz").get()
  ...
  const imageUrl = "https://firebasestorage.googleapis.com/v0/b/gaogeet.appspot.com/o/mybiblesong%2Fsongapp%2Fbiblequizbanner%2Fmybiblesong-quiz-banner-1.jpg?alt=media&token=3a087fb8-1975-4e40-abcb-86fab9010b60"
